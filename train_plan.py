...
from utils import get_checkpoint_dir, get_latest_checkpoint, get_latest_checkpoint_plus1,get_latest_checkpoint_plus10, get_new_checkpoint_path, get_root_dir, get_image_memory  # Ensure these are accessible
...
async def main():
    ...
    current_step = 0
    while True:
        perform_final_training(wandb_run, current_step == total_steps)
